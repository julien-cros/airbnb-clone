...
export default function Header({placeholder}) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
		...
		{/* middle part */}
		<div className="flex items-center md:border-2 rounded-full py-2 md:shadow-msm">  {/*justify-between p-2*/}
			<input
				value={searchInput}
		...
		<div className="flex items-center space-x-4 justify-end text-gray-500">
			...
			<div className="flex  space-x-2 items-center p-2 border-2 rounded-full">
